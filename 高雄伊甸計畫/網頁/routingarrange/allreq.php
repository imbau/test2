<?php
	...
	$rs1 = mysql_query("SELECT *FROM userrequests WHERE arranged<=0 AND arrangedate = '".$arrangedate."' AND arrangetime = '".$arrangetime."'");
...
<body>
  <div class="container">    
	...
	{*/
     ...
     echo "<tr><th>流水號</th><th>姓名</th><th>狀態</th><th>帳號</th><th>時段</th><th>旅行時間</th><th>指定車種</th><th>上車區域</th><th>上車地址</th><th>下車區域</th><th>下車地址</th><th>修改交通時間(以秒為單位)</th></tr>";
